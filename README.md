...
Send me a message at `magic8.eth` (0x458dd9C5bf4d4E8f80Ba88923E3b94FD028CEe38) using an app built with [XMTP](https://docs.xmtp.org/). 
...
- I was vibe-coded by a [non-coder](https://bsky.app/profile/alohajha.bsky.social) using Claude Code.
